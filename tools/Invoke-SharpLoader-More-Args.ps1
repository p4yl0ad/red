...
elseif ($argument14)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4", "$argument5", "$argument6", "$argument7", "$argument8", "$argument9", "$argument10", "$argument11", "$argument12", "$argument13", "$argument14")
}
elseif ($argument13)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4", "$argument5", "$argument6", "$argument7", "$argument8", "$argument9", "$argument10", "$argument11", "$argument12", "$argument13")
}
elseif ($argument12)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4", "$argument5", "$argument6", "$argument7", "$argument8", "$argument9", "$argument10", "$argument11", "$argument12")
}
elseif ($argument11)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4", "$argument5", "$argument6", "$argument7", "$argument8", "$argument9", "$argument10", "$argument11")
}
elseif ($argument10)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4", "$argument5", "$argument6", "$argument7", "$argument8", "$argument9", "$argument10")
}
elseif ($argument9)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4", "$argument5", "$argument6", "$argument7", "$argument8", "$argument9")
}
elseif ($argument8)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4", "$argument5", "$argument6", "$argument7", "$argument8")
}
elseif ($argument7)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4", "$argument5", "$argument6", "$argument7")
}
elseif ($argument6)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4", "$argument5", "$argument6")
}
elseif ($argument5)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4", "$argument5")
}
elseif ($argument4)
{
    [SharpLoader.Program]::Main("$location","$password","$argument","$argument2", "$argument3", "$argument4")
}
elseif ($argument3)
{
